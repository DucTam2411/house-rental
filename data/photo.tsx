...
const unsplashLink = (id: string, width: number, height: number) => {
    if (id === "a") {
        return "https://images.pexels.com/photos/2102587/pexels-photo-2102587.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2";
    } else {
...
let photos: any = [
    {
        src: "https://images.pexels.com/photos/1544420/pexels-photo-1544420.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        width: 100,
        height: 300,
        images: [],
    },
...
photos = unsplashPhotos.map((photo) => ({
